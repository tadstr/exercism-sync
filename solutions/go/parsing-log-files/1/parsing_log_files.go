...
func TagWithUserName(lines []string) []string {
	// Compile the regex to find "User" followed by one or more spaces,
	// and capture the subsequent non-whitespace characters (the username).
	// Compiling it once outside the loop is more efficient.
